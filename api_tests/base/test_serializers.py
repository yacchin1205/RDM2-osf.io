    ...
    def test_registration_serializer(self):
        ...
        for field in NodeSerializer._declared_fields:
            ...
            if field not in visible_on_withdrawals and field not in non_registration_fields:
                assert isinstance(reg_field, base_serializers.HideIfWithdrawal) or isinstance(reg_field, base_serializers.ShowIfVersion) or isinstance(reg_field, base_serializers.ShowIfAdminScopeOrAnonymous)
...
class TestRelationshipField:
    ...
    def test_self_and_related_fields(self):
        ...
        assert '/v2/nodes/{}/contributors/'.format(node._id) in relationship_field['self']['href']
        assert '/v2/nodes/{}/'.format(node._id) in relationship_field['related']['href']
    ...
    def test_field_with_two_kwargs(self):
        ...
        assert '/v2/nodes/{}/node_links/{}/'.format(node._id, node._id) in field['related']['href']
    ...
    def test_field_with_callable_related_attrs(self):
        ...
        assert '/v2/nodes/{}/'.format(node._id) in field['related']['href']
...
class VersionedDateTimeField(DbTestCase):
    ...
    def test_old_date_without_microseconds_formats_to_old_format(self):
        ...
        data = NodeSerializer(self.node, context={'request': req}).data['data']
        assert datetime.strftime(self.old_date_without_microseconds, self.old_format_without_microseconds) == data['attributes']['date_modified']
    ...
    def test_old_date_without_microseconds_formats_to_new_format(self):
        ...
        setattr(self.node, 'last_logged', self.old_date_without_microseconds)
        data = NodeSerializer(self.node, context={'request': req}).data['data']
        assert datetime.strftime(self.old_date_without_microseconds, self.new_format) == data['attributes']['date_modified']
    ...
    def test_new_date_without_microseconds_formats_to_old_format(self):
        ...
        data = NodeSerializer(self.node, context={'request': req}).data['data']
        assert datetime.strftime(self.new_date_without_microseconds, self.old_format_without_microseconds) == data['attributes']['date_modified']
    ...
    def test_new_date_without_microseconds_formats_to_new_format(self):
        ...
        setattr(self.node, 'last_logged', self.new_date_without_microseconds)
        data = NodeSerializer(self.node, context={'request': req}).data['data']
        assert datetime.strftime(self.new_date_without_microseconds, self.new_format) == data['attributes']['date_modified']
