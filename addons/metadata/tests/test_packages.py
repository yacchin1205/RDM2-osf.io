...
class TestExportAndImport(OsfTestCase):
    ...
    def test_files_only(self):
        ...
        assert json_entities['@context'] == ['https://w3id.org/ro/crate/1.1/context', 'https://w3id.org/ro/terms/workflow-run', 'https://purl.org/gakunin-rdm/project/0.1']
        assert [e['@id'] for e in json_entities['@graph']] == ['./', 'ro-crate-metadata.json', 'root/osfstorage/sample/file_in_folder', 'root/osfstorage/sample/sub_folder/file_in_sub_folder', './root/osfstorage/sample/sub_folder/', '#./root/osfstorage/sample/sub_folder/#0', '#metadata-schema-公的資金による研究データのメタデータ登録-3', './root/osfstorage/sample/empty/', './root/osfstorage/sample/', 'root/osfstorage/file_in_root', '#root/osfstorage/file_in_root#0', '#root-osfstorage', '#root-metadata', '#root', '#creator0']
        assert remove_fields(_find_entity_by_id(json_entities, './'), fields=['datePublished']) == {'@id': './', '@type': 'Dataset', 'hasPart': [{'@id': 'root/osfstorage/sample/file_in_folder'}, {'@id': 'root/osfstorage/sample/sub_folder/file_in_sub_folder'}, {'@id': './root/osfstorage/sample/sub_folder/'}, {'@id': './root/osfstorage/sample/empty/'}, {'@id': './root/osfstorage/sample/'}, {'@id': 'root/osfstorage/file_in_root'}]}
        assert 'datePublished' in _find_entity_by_id(json_entities, './')
        assert remove_fields(_find_entity_by_id(json_entities, 'root/osfstorage/file_in_root'), fields=['rdmURL']) == {'@id': 'root/osfstorage/file_in_root', '@type': 'File', 'contentSize': '9', 'dateCreated': None, 'dateModified': None, 'encodingFormat': None, 'keywords': [], 'name': 'file_in_root'}
        assert 'rdmURL' in _find_entity_by_id(json_entities, 'root/osfstorage/file_in_root')
        assert remove_fields(_find_entity_by_id(json_entities, '#root/osfstorage/file_in_root#0'), fields=['dateCreated', 'dateModified']) == {'@id': '#root/osfstorage/file_in_root#0', '@type': 'RDMFileMetadata', 'about': {'@id': 'root/osfstorage/file_in_root'}, 'encodingFormat': 'application/json', 'rdmSchema': {'@id': '#metadata-schema-公的資金による研究データのメタデータ登録-3'}, 'text': '{"test": true}', 'version': 'active'}
        assert _find_entity_by_id(json_entities, '#metadata-schema-公的資金による研究データのメタデータ登録-3') == {'@id': '#metadata-schema-公的資金による研究データのメタデータ登録-3', '@type': 'RDMMetadataSchema', 'name': '公的資金による研究データのメタデータ登録', 'version': 3}
        assert _find_entity_by_id(json_entities, 'ro-crate-metadata.json') == {'@id': 'ro-crate-metadata.json', '@type': 'CreativeWork', 'about': {'@id': './'}, 'conformsTo': {'@id': 'https://w3id.org/ro/crate/1.1'}}
        assert _find_entity_by_id(json_entities, '#root-osfstorage') == {'@id': '#root-osfstorage', '@type': 'RDMAddon', 'about': {'@id': '#root'}, 'description': 'NII Storage', 'hasPart': [{'@id': './root/osfstorage/sample/'}, {'@id': 'root/osfstorage/file_in_root'}], 'name': 'osfstorage'}
        assert _find_entity_by_id(json_entities, '#root-metadata') == {'@id': '#root-metadata', '@type': 'RDMAddon', 'about': {'@id': '#root'}, 'description': 'Metadata', 'name': 'metadata'}
        assert remove_fields(_find_entity_by_id(json_entities, '#root'), fields=['dateCreated', 'dateModified', 'name']) == {'@id': '#root', '@type': 'RDMProject', 'about': {'@id': './'}, 'category': 'project', 'contributor': [{'@id': '#creator0'}], 'creator': {'@id': '#creator0'}, 'description': 'TEST_DESCRIPTION', 'hasPart': [], 'keywords': ['Test Node']}
        ...
        assert _find_entity_by_id(json_entities, '#creator0') == {'@id': '#creator0', '@type': 'Person', 'familyName': [{'@language': 'en', '@value': creator.family_name}], 'givenName': [{'@language': 'en', '@value': creator.given_name}], 'identifier': [], 'name': creator.given_name + ' ' + creator.family_name}
    ...
    def test_comments_and_files_only(self):
        ...
        json_entities = _get_ro_crate_from(zip_path)
        assert json_entities['@context'] == ['https://w3id.org/ro/crate/1.1/context', 'https://w3id.org/ro/terms/workflow-run', 'https://purl.org/gakunin-rdm/project/0.1']
        assert [e['@id'] for e in json_entities['@graph']] == ['./', 'ro-crate-metadata.json', 'root/osfstorage/sample/file_in_folder', 'root/osfstorage/sample/sub_folder/file_in_sub_folder', './root/osfstorage/sample/sub_folder/', '#./root/osfstorage/sample/sub_folder/#0', '#metadata-schema-公的資金による研究データのメタデータ登録-3', './root/osfstorage/sample/empty/', './root/osfstorage/sample/', 'root/osfstorage/file_in_root', '#root/osfstorage/file_in_root#0', '#root-osfstorage', '#root-metadata', '#root', '#comment#0', '#comment#1', '#comment#2', '#creator0']
        assert remove_fields(_find_entity_by_id(json_entities, './'), fields=['datePublished']) == {'@id': './', '@type': 'Dataset', 'hasPart': [{'@id': 'root/osfstorage/sample/file_in_folder'}, {'@id': 'root/osfstorage/sample/sub_folder/file_in_sub_folder'}, {'@id': './root/osfstorage/sample/sub_folder/'}, {'@id': './root/osfstorage/sample/empty/'}, {'@id': './root/osfstorage/sample/'}, {'@id': 'root/osfstorage/file_in_root'}]}
        assert 'datePublished' in _find_entity_by_id(json_entities, './')
        assert remove_fields(_find_entity_by_id(json_entities, 'root/osfstorage/file_in_root'), fields=['rdmURL']) == {'@id': 'root/osfstorage/file_in_root', '@type': 'File', 'contentSize': '9', 'dateCreated': None, 'dateModified': None, 'encodingFormat': None, 'keywords': [], 'name': 'file_in_root'}
        assert 'rdmURL' in _find_entity_by_id(json_entities, 'root/osfstorage/file_in_root')
        ...
        assert remove_fields(_find_entity_by_id(json_entities, '#comment#0'), fields=['dateCreated', 'dateModified']) == {'@id': '#comment#0', '@type': 'Comment', 'about': {'@id': '#root'}, 'author': {'@id': '#creator0'}, 'text': 'Reply comment'}
        ...
        assert remove_fields(_find_entity_by_id(json_entities, '#comment#1'), fields=['dateCreated', 'dateModified']) == {'@id': '#comment#1', '@type': 'Comment', 'about': {'@id': '#root'}, 'author': {'@id': '#creator0'}, 'text': 'Comment for the node'}
        ...
        assert remove_fields(_find_entity_by_id(json_entities, '#comment#2'), fields=['dateCreated', 'dateModified']) == {'@id': '#comment#2', '@type': 'Comment', 'about': {'@id': './root/osfstorage/file_in_root'}, 'author': {'@id': '#creator0'}, 'text': 'Comment for the file file_in_root'}
    ...
    def test_logs_and_files_only(self):
        ...
        json_entities = _get_ro_crate_from(zip_path)
        assert json_entities['@context'] == ['https://w3id.org/ro/crate/1.1/context', 'https://w3id.org/ro/terms/workflow-run', 'https://purl.org/gakunin-rdm/project/0.1']
        assert [e['@id'] for e in json_entities['@graph']] == ['./', 'ro-crate-metadata.json', 'root/osfstorage/sample/file_in_folder', 'root/osfstorage/sample/sub_folder/file_in_sub_folder', './root/osfstorage/sample/sub_folder/', '#./root/osfstorage/sample/sub_folder/#0', '#metadata-schema-公的資金による研究データのメタデータ登録-3', './root/osfstorage/sample/empty/', './root/osfstorage/sample/', 'root/osfstorage/file_in_root', '#root/osfstorage/file_in_root#0', '#root-osfstorage', '#root-metadata', '#root', '#action#0', '#action#1', '#action#2', '#creator0']
        assert remove_fields(_find_entity_by_id(json_entities, './'), fields=['datePublished']) == {'@id': './', '@type': 'Dataset', 'hasPart': [{'@id': 'root/osfstorage/sample/file_in_folder'}, {'@id': 'root/osfstorage/sample/sub_folder/file_in_sub_folder'}, {'@id': './root/osfstorage/sample/sub_folder/'}, {'@id': './root/osfstorage/sample/empty/'}, {'@id': './root/osfstorage/sample/'}, {'@id': 'root/osfstorage/file_in_root'}]}
        assert 'datePublished' in _find_entity_by_id(json_entities, './')
        assert remove_fields(_find_entity_by_id(json_entities, 'root/osfstorage/file_in_root'), fields=['rdmURL']) == {'@id': 'root/osfstorage/file_in_root', '@type': 'File', 'contentSize': '9', 'dateCreated': None, 'dateModified': None, 'encodingFormat': None, 'keywords': [], 'name': 'file_in_root'}
        assert 'rdmURL' in _find_entity_by_id(json_entities, 'root/osfstorage/file_in_root')
        ...
        assert remove_fields(_find_entity_by_id(json_entities, '#action#0'), fields=['startTime']) == {'@id': '#action#0', '@type': 'Action', 'agent': {'@id': '#creator0'}, 'name': 'metadata_file_added'}
        assert 'startTime' in _find_entity_by_id(json_entities, '#action#0')
        assert remove_fields(_find_entity_by_id(json_entities, '#action#1'), fields=['startTime']) == {'@id': '#action#1', '@type': 'Action', 'agent': {'@id': '#creator0'}, 'name': 'metadata_file_added'}
        ...
        assert remove_fields(_find_entity_by_id(json_entities, '#action#2'), fields=['startTime']) == {'@id': '#action#2', '@type': 'Action', 'agent': {'@id': '#creator0'}, 'name': 'project_created'}
    ...
    def test_wiki_only(self):
        ...
        assert remove_fields(_find_entity_by_id(json_entities, './'), fields=['datePublished']) == {'@id': './', '@type': 'Dataset', 'hasPart': [{'@id': 'root/wiki/test'}]}
        assert 'datePublished' in _find_entity_by_id(json_entities, './')
        assert _find_entity_by_id(json_entities, 'ro-crate-metadata.json') == {'@id': 'ro-crate-metadata.json', '@type': 'CreativeWork', 'about': {'@id': './'}, 'conformsTo': {'@id': 'https://w3id.org/ro/crate/1.1'}}
        assert _find_entity_by_id(json_entities, '#root-osfstorage') == {'@id': '#root-osfstorage', '@type': 'RDMAddon', 'about': {'@id': '#root'}, 'description': 'NII Storage', 'hasPart': [], 'name': 'osfstorage'}
        assert _find_entity_by_id(json_entities, '#root-metadata') == {'@id': '#root-metadata', '@type': 'RDMAddon', 'about': {'@id': '#root'}, 'description': 'Metadata', 'name': 'metadata'}
        assert remove_fields(_find_entity_by_id(json_entities, 'root/wiki/test'), fields=['dateCreated', 'dateModified']) == {'@id': 'root/wiki/test', '@type': 'File', 'contentSize': '14', 'encodingFormat': 'text/markdown', 'name': 'test', 'version': 1}
        ...
        assert _find_entity_by_id(json_entities, '#root-wiki') == {'@id': '#root-wiki', '@type': 'RDMAddon', 'about': {'@id': '#root'}, 'description': 'Wiki', 'hasPart': [{'@id': 'root/wiki/test'}], 'name': 'wiki'}
        assert remove_fields(_find_entity_by_id(json_entities, '#root'), fields=['dateCreated', 'dateModified', 'name']) == {'@id': '#root', '@type': 'RDMProject', 'about': {'@id': './'}, 'category': 'project', 'contributor': [{'@id': '#creator0'}], 'creator': {'@id': '#creator0'}, 'description': 'TEST_DESCRIPTION', 'hasPart': [], 'keywords': ['Test Node']}
        assert 'dateCreated' in _find_entity_by_id(json_entities, '#root')
        assert 'dateModified' in _find_entity_by_id(json_entities, '#root')
        assert 'name' in _find_entity_by_id(json_entities, '#root')
    ...
    def test_child_nodes(self):
        ...
        assert len([e for e in json_entities['@graph'] if e['@type'] == 'Comment']) == 0
        assert len([e for e in json_entities['@graph'] if e['@type'] == 'Action']) == 0
        assert [e['@id'] for e in json_entities['@graph']] == ['./', 'ro-crate-metadata.json', '#node1-osfstorage', '#node1-metadata', 'node1/wiki/test', '#node1-wiki', '#root-osfstorage', '#root-metadata', '#root-wiki', '#root', '#node1', '#creator0']
        assert remove_fields(_find_entity_by_id(json_entities, './'), fields=['datePublished']) == {'@id': './', '@type': 'Dataset', 'hasPart': [{'@id': 'node1/wiki/test'}]}
        assert 'datePublished' in _find_entity_by_id(json_entities, './')
        assert _find_entity_by_id(json_entities, 'ro-crate-metadata.json') == {'@id': 'ro-crate-metadata.json', '@type': 'CreativeWork', 'about': {'@id': './'}, 'conformsTo': {'@id': 'https://w3id.org/ro/crate/1.1'}}
        assert _find_entity_by_id(json_entities, '#root-osfstorage') == {'@id': '#root-osfstorage', '@type': 'RDMAddon', 'about': {'@id': '#root'}, 'description': 'NII Storage', 'hasPart': [], 'name': 'osfstorage'}
        assert _find_entity_by_id(json_entities, '#root-metadata') == {'@id': '#root-metadata', '@type': 'RDMAddon', 'about': {'@id': '#root'}, 'description': 'Metadata', 'name': 'metadata'}
        assert _find_entity_by_id(json_entities, '#root-wiki') == {'@id': '#root-wiki', '@type': 'RDMAddon', 'about': {'@id': '#root'}, 'description': 'Wiki', 'hasPart': [], 'name': 'wiki'}
        assert remove_fields(_find_entity_by_id(json_entities, '#root'), fields=['dateCreated', 'dateModified', 'name']) == {'@id': '#root', '@type': 'RDMProject', 'about': {'@id': './'}, 'category': 'project', 'contributor': [{'@id': '#creator0'}], 'creator': {'@id': '#creator0'}, 'description': 'TEST_COMPOSITE_DESCRIPTION', 'hasPart': [{'@id': '#node1'}], 'keywords': ['Composite Node']}
        assert 'dateCreated' in _find_entity_by_id(json_entities, '#root')
        assert 'dateModified' in _find_entity_by_id(json_entities, '#root')
        assert 'name' in _find_entity_by_id(json_entities, '#root')
        assert remove_fields(_find_entity_by_id(json_entities, '#node1'), fields=['dateCreated', 'dateModified', 'name']) == {'@id': '#node1', '@type': 'RDMProject', 'category': 'project', 'contributor': [{'@id': '#creator0'}], 'creator': {'@id': '#creator0'}, 'description': 'TEST_SUB_DESCRIPTION', 'hasPart': [], 'keywords': ['Sub Node']}
        ...
        assert _find_entity_by_id(json_entities, '#node1-osfstorage') == {'@id': '#node1-osfstorage', '@type': 'RDMAddon', 'about': {'@id': '#node1'}, 'description': 'NII Storage', 'hasPart': [], 'name': 'osfstorage'}
        _assert_dict_matches(_find_entity_by_id(json_entities, '#creator0'), {
            '@id': '#creator0',
            '@type': 'Person',
            'familyName': [
    ...
    def test_simple_extraction(self):
        ...
        with mock.patch.object(ROCrateExtractor, '_download') as mock_request:
            ...
            assert [t.name for t in new_node.get_addon('osfstorage').get_root().find_child_by_name('file_in_folder').tags.all()] == ['Test File']
            schema = RegistrationSchema.objects \
                .filter(name='公的資金による研究データのメタデータ登録') \
                .order_by('-schema_version') \
                .first()
            assert new_node.get_addon('metadata').get_file_metadata_for_path('osfstorage/file_in_root')['items'] == [{'active': True, 'schema': schema._id, 'data': {'test': True}}]
            assert new_node.get_addon('metadata').get_file_metadata_for_path('osfstorage/sample/sub_folder/')['items'] == [{'active': True, 'schema': schema._id, 'data': {'test': True, 'this_is_folder': True}}]
    ...
    def test_composite_extraction(self):
        ...
        with mock.patch.object(ROCrateExtractor, '_download') as mock_request:
            ...
            schema = RegistrationSchema.objects \
                ...
                .order_by('-schema_version') \
                .first()
            assert new_node.get_addon('metadata').get_file_metadata_for_path('osfstorage/file_in_composite_root')['items'] == [{'active': True, 'schema': schema._id, 'data': {'test': True}}]
            new_wb_upload_file.assert_has_calls([
