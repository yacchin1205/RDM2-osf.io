...
class TestNodeSettings(unittest.TestCase):
    ...
    def test_set_valid_folder_file_metadata(self):
        ...
        assert remove_fields(self.node_settings.get_file_metadata_for_path('osfstorage/'), fields=['modified', 'created']) == metadata
    ...
    def test_update_file_metadata_for_renamed(
        ...
        assert remove_fields(self.node_settings.get_file_metadata_for_path('osfstorage/testfile2'), fields=['created', 'modified']) == {'generated': False, 'path': 'osfstorage/testfile2', 'folder': False, 'hash': '1234567890', 'urlpath': '/testFileGUID/', 'items': [{'active': True, 'schema': 'xxxx', 'data': {'test': True}}]}
        last_log = self.node.logs.latest()
        assert last_log.action == 'metadata_file_deleted'
    ...
    def test_update_file_metadata_for_file_moved_from_node_with_metadata(
        ...
        assert remove_fields(self.node_settings.get_file_metadata_for_path('osfstorage/testfile'), fields=['created', 'modified']) == {'generated': False, 'path': 'osfstorage/testfile', 'folder': False, 'hash': '1234567890', 'urlpath': '/testFileGUID/', 'items': [{'active': True, 'schema': 'xxxx', 'data': {'test': True}}]}
        last_log = self.node.logs.latest()
        assert last_log.action == 'metadata_file_added'
        ...
        assert remove_fields(self.node_with_metadata_settings.get_file_metadata_for_path('osfstorage/test/testfile'), fields=['created', 'modified']) == {'generated': False, 'path': 'osfstorage/test/testfile', 'folder': False, 'hash': '1234567890', 'urlpath': '/testFileGUID/', 'items': [{'active': True, 'schema': 'xxxx', 'data': {'test': True}}]}
        last_log = self.node.logs.latest()
        assert last_log.action == 'metadata_file_deleted'
        last_log = self.node_with_metadata.logs.latest()
        assert last_log.action == 'metadata_file_added'
    ...
    def test_update_file_metadata_for_folder_moved_from_node_with_metadata(
        ...
        assert remove_fields(self.node_settings.get_file_metadata_for_path('osfstorage/test1/test/testfile'), fields=['created', 'modified']) == {'generated': False, 'path': 'osfstorage/test1/test/testfile', 'folder': False, 'hash': '1234567890', 'urlpath': '/testFileGUID/', 'items': [{'active': True, 'schema': 'xxxx', 'data': {'test': True}}]}
    ...
    def test_update_file_metadata_for_folder_metadata_moved_from_node_with_metadata(
        ...
        assert remove_fields(self.node_with_metadata_settings.get_file_metadata_for_path('osfstorage/test/'), fields=['created', 'modified']) == {'generated': False, 'path': 'osfstorage/test/', 'folder': True, 'hash': '1234567890', 'urlpath': '/testFileGUID/', 'items': [{'active': True, 'schema': 'xxxx', 'data': {'test': True}}]}
        assert self.node_with_metadata.logs.latest().action == 'metadata_file_added'
        assert self.node.logs.latest().action == 'metadata_file_deleted'
        ...
        assert remove_fields(self.node_settings.get_file_metadata_for_path('osfstorage/test1/test/'), fields=['created', 'modified']) == {'generated': False, 'path': 'osfstorage/test1/test/', 'folder': True, 'hash': '1234567890', 'urlpath': '/testFileGUID/', 'items': [{'active': True, 'schema': 'xxxx', 'data': {'test': True}}]}
        assert self.node_with_metadata.logs.latest().action == 'metadata_file_deleted'
        assert self.node.logs.latest().action == 'metadata_file_added'
