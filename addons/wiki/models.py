...
class WikiPageNodeManager(models.Manager):
    ...
    def create(self, is_wiki_import=False, **kwargs):
        obj = self.model(**kwargs)
        self._for_write = True
        obj.save(force_insert=True, using=self.db, is_wiki_import=is_wiki_import)
        return obj
