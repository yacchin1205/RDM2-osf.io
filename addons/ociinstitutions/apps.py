...
from addons.ociinstitutions.settings import MAX_UPLOAD_SIZE

FULL_NAME = 'Oracle Cloud Infrastructure for Institutions'
SHORT_NAME = 'ociinstitutions'
...
class OCIInstitutionsAddonAppConfig(BaseAddonAppConfig):
    default = True
    ...
    user_settings_template = os.path.join(
        TEMPLATE_PATH, 'ociinstitutions_user_settings.mako')
    # node_settings_template is not used.

    get_hgrid_data = ociinstitutions_root
