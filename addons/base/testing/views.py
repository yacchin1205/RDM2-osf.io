...
class OAuthAddonAuthViewsTestCaseMixin(OAuthAddonTestCaseMixin):
    ...
    def test_oauth_start_rdm_addons_denied(self):
        ...
        assert (b'You are prohibited from using this add-on.') in (res.body)
    ...
    def test_delete_external_account(self):
        ...
        assert not (self.user.external_accounts)
...
class OAuthAddonConfigViewsTestCaseMixin(OAuthAddonTestCaseMixin):
    ...
    def test_import_auth(self):
        ...
        assert (last_log.action) == ('{0}_node_authorized'.format(self.ADDON_SHORT_NAME))
    ...
    def test_set_config(self):
        ...
        assert (res.status_code) == (http_status.HTTP_200_OK)
        self.project.reload()
        assert (self.project.logs.latest().action) == ('{0}_folder_selected'.format(self.ADDON_SHORT_NAME))
