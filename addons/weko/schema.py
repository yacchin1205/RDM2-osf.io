...
columns_system = [
    ('.metadata.item_1617186819068.subitem_identifier_reg_text', 'Identifier Registration.ID登録', 'System', '', ''),
    ('.metadata.item_1617186819068.subitem_identifier_reg_type', 'Identifier Registration.ID登録タイプ', 'System', '', ''),
    ('.metadata.item_1617186476635.subitem_1600958577026', 'Access Rights.アクセス権URI', 'System', '', 'http://purl.org/coar/access_right/c_abf2'),
    ('.metadata.item_1617258105262.resourceuri', 'Resource Type.資源タイプ識別子', 'System', 'Required', 'http://purl.org/coar/resource_type/c_5794'),
    ('.metadata.item_1617265215918.subitem_1600292170262', 'Version Type.出版タイプResource', 'System', '', 'http://purl.org/coar/version/c_b1a7d7d4d402bcce'),
]
...
mapping_table = {'pubdate': 'pubdate',
    ...
    'items': {
        ...
        'nameIdentifiers[0].nameIdentifierURI': {'type': 'const', 'value': ''},
        'nameIdentifiers[0].nameIdentifier': {'type': 'const', 'value': ''},
        'contributorNames[0].contributorName': {'type': 'jsonproperty', 'key': 'Creator', 'value': 'name_ja'},
        'contributorNames[0].lang': {'type': 'const', 'value': 'ja'},
        'contributorNames[1].contributorName': {'type': 'jsonproperty', 'key': 'Creator', 'value': 'name_en'},
        'contributorNames[1].lang': {'type': 'const', 'value': 'en'},
        'familyNames[0].familyName': {'type': 'const', 'value': ''},
        'familyNames[0].familyNameLang': {'type': 'const', 'value': 'ja'},
        'givenNames[0].givenName': {'type': 'const', 'value': ''},
        'givenNames[0].givenNameLang': {'type': 'const', 'value': 'ja'},
        'creatorAlternatives[0].creatorAlternative': {'type': 'const', 'value': ''},
        'creatorAlternatives[0].creatorAlternativeLang': {'type': 'const',
        'value': 'ja'},
...
def _get_metadata_value(file_metadata_data, item, lang, index):
    ...
    if item['type'] == 'jsonproperty':
        logger.info(f'jsonproperty: {value}')
