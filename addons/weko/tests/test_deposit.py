...
class TestWEKOBagIt(OsfTestCase):
    ...
    def test_single_file(self, mock_create_log, mock_create_client, mock_wb):
        ...
        assert_true(os.path.exists(os.path.join(tmp_dir, 'data/dummy')))

        assert_equal(open(os.path.join(tmp_dir, 'data/dummy'), 'r').read(), dummy_text)
        ...
        assert_in('data/dummy', manifest_sha256_content)
        ...
        assert_in('data/dummy', manifest_sha512_content)
