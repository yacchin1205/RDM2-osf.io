<div id="s3compatsigv4InputCredentials" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <div class="modal-header">
                <h3>${_("Connect an S3 Compatible Storage (SigV4) Account")}</h3>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="s3compatsigv4Addon">${_("Secret Key")}</label>
