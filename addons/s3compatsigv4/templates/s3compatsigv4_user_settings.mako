<!-- Authorization -->
<div id='s3compatsigv4AddonScope' class='addon-settings addon-generic scripted'
    ...
    <h4 class="addon-title">
        ...
        <small>
            <a href="#s3compatsigv4InputCredentials" data-toggle="modal" class="pull-right text-primary">${_("Connect or Reauthorize Account")}</a>
        </small>
    </h4>
