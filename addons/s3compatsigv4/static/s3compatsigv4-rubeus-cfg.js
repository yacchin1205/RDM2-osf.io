    ...
    Rubeus.cfg.s3compatsigv4 = {
        ...
        uploadSuccess: function(file, row) {
            ...
            row.urls = {
                'delete': parent.nodeApiUrl + 's3compatsigv4/' + file.destination + '/',
                'download': parent.nodeUrl + 's3compatsigv4/' + file.destination + '/download/',
                'view': parent.nodeUrl + 's3compatsigv4/' + file.destination + '/'
            };
