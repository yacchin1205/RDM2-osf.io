...
class OneDriveBusinessAddonTestCase(OAuthAddonTestCaseMixin, AddonTestCase):
    ...
    def test_get_region_external_account_with_configured_institutions(
        ...
        mock_region_external_account_object = mock.Mock()
        mock_region_object = mock.Mock()
        mock_region_objects_get.return_value = mock_region_object
        mock_region_external_account_objects_get.return_value = mock_region_external_account_object

        mock_region_external_account_object.external_account = mock.Mock()
        mock_region_external_account_object.external_account.test = True
        mock_region_external_account_object.external_account.provider_name = 'onedrivebusiness'

        ret = utils.get_region_external_account(mock_node)
        assert_true(ret is not None)
        assert_true(ret.external_account.test)

    @mock.patch('addons.onedrivebusiness.utils.RdmAddonOption.objects.filter')
    @mock.patch('addons.onedrivebusiness.utils.Region.objects.get')
    @mock.patch('addons.onedrivebusiness.utils.RegionExternalAccount.objects.get')
    def test_get_region_external_account_with_another_addons(
        self,
        mock_region_external_account_objects_get,
        mock_region_objects_get,
        mock_rdm_addon_option_objects_filter
        ...
        mock_region_external_account_object.external_account = mock.Mock()
        mock_region_external_account_object.external_account.test = True
        mock_region_external_account_object.external_account.provider_name = 'anotheraddon'
    ...
    @mock.patch('addons.onedrivebusiness.utils.RdmAddonOption.objects.filter')
    @mock.patch('addons.onedrivebusiness.utils.Region.objects.get')
    def test_get_region_external_account_without_region(
        self,
        mock_region_objects_get,
        mock_rdm_addon_option_objects_filter
    ):
        ...
        mock_region_objects_get.side_effect = Region.DoesNotExist
    ...
    @mock.patch('addons.onedrivebusiness.utils.Region.objects.get')
    @mock.patch('addons.onedrivebusiness.utils.RegionExternalAccount.objects.get')
    def test_get_region_external_account_without_region_external_account(
        self,
        mock_region_external_account_objects_get,
        mock_region_objects_get,
        mock_rdm_addon_option_objects_filter
        ...
        mock_region_object = mock.Mock()
        mock_region_objects_get.return_value = mock_region_object
        mock_region_external_account_objects_get.side_effect = RegionExternalAccount.DoesNotExist
