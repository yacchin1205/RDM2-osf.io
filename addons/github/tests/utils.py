...
def create_mock_github(user='octo-cat', private=False):
    ...
    github_mock.branches.return_value = [
        Branch.from_json(dumps({
            'commit': {
                'sha': 'e22d92d5d90bb8f9695e9a5e2e2311a5c1997230',
                'url': 'https://api.github.com/repos/{}/mock-repo/commits/e22d92d5d90bb8f9695e9a5e2e2311a5c1997230'.format(user),
                'author': repo_author,
        ...
        Branch.from_json(dumps({
            'commit': {
                ...
                'url': 'https://api.github.com/repos/{}/mock-repo/commits/444a74d0d90a4aea744dacb31a14f87b5c30759c'.format(user),
                'author': repo_author,
                'comments_url': 'https://api.github.com/repos/{user}/mock-repo/comments{{/number}}',
                'commit': repo_commit,
                'committer': repo_author,
        ...
        Branch.from_json(dumps({
            'commit': {
                ...
                'url': 'https://api.github.com/repos/{}/mock-repo/commits/c6eaaf6708561c3d4439c0c8dd99c2e33525b1e6'.format(user),
                'author': repo_author,
                'comments_url': 'https://api.github.com/repos/{user}/mock-repo/comments{{/number}}',
                'commit': repo_commit,
                'committer': repo_author,
