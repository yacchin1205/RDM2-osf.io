...
class TestUtils(DataverseAddonTestCase):
    ...
    def test_mock_connection(self):
        ...
        assert (mock_connection.get_dataverse(mock_connection.get_dataverses()[1].alias)) == (mock_connection.get_dataverses()[1])
    ...
    def test_mock_dataset(self):
        ...
        assert (mock_dataset.citation) == ('Example Citation for {0}'.format(dataset_id))
        assert (mock_dataset.title) == ('Example ({0})'.format(dataset_id))
        assert (mock_dataset.doi) == (doi)
