...
class TestSearchViews(OsfTestCase):
    ...
    def test_search_views(self):
        ...
        res = self.app.get(url, query_string={'query': self.contrib.fullname}, auth=factories.AuthUserFactory().auth)
        ...
        res = self.app.get(url, query_string={'query': 'Serena'}, auth=factories.AuthUserFactory().auth)
        assert res.status_code == 200
        result = res.json['users']
        ...
        #Test default page 1
        res = self.app.get(url, query_string={'query': 'Serena', 'page': 1}, auth=factories.AuthUserFactory().auth)
        assert res.status_code == 200
        result = res.json['users']
        page = res.json['page']
        assert len(result) == 5
        ...
        #Test default page 2
        res = self.app.get(url, query_string={'query': 'Serena', 'page': 2}, auth=factories.AuthUserFactory().auth)
        assert res.status_code == 200
        result = res.json['users']
        page = res.json['page']
        assert len(result) == 2
        ...
        #Test smaller pages
        res = self.app.get(url, query_string={'query': 'Serena', 'size': 5}, auth=factories.AuthUserFactory().auth)
        assert res.status_code == 200
        result = res.json['users']
        pages = res.json['pages']
        page = res.json['page']
        ...
        res = self.app.get(url, query_string={'query': 'Serena', 'page': 2, 'size': 5}, auth=factories.AuthUserFactory().auth)
        assert res.status_code == 200
        result = res.json['users']
        pages = res.json['pages']
        page = res.json['page']
