    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_is_preprint_orphan', models.BooleanField(null=True, default=False)),
                ...
                ('is_bookmark_collection', models.BooleanField(null=True, db_index=True, default=False)),
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('mark_spam', 'Can mark comments, projects and registrations as spam'), ('view_spam', 'Can view nodes, comments, and projects marked as spam'), ('view_metrics', 'Can view metrics on the GakuNin RDM Admin app'), ('view_prereg', 'Can view entries for the preregistration chellenge on the admin'), ('administer_prereg', 'Can update, comment on, and approve entries to the prereg challenge'), ('view_desk', 'Can view details about Desk users')),
            },
        ),
        migrations.CreateModel(
