...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=('osf.onedrivebusinessfilenode', models.Model),
        ),
        migrations.CreateModel(
            name='OneDriveBusinessFolder',
            fields=[
            ],
            options={
                'proxy': True,
