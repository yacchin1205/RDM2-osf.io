...
urlpatterns = [
    ...
    re_path(r'^(?P<node_id>\w+)/map_core/groups/$', views.NodeMapCoreGroupList.as_view(), name=views.NodeMapCoreGroupList.view_name),
    re_path(r'^(?P<node_id>\w+)/map_core/groups/(?P<node_group_id>[0-9]+)/$', views.NodeMapCoreGroupRemove.as_view(), name=views.NodeMapCoreGroupList.view_name),
]
