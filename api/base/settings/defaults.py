...
ADDONS_FOLDER_CONFIGURABLE = ['box', 'dropbox', 's3', 'swift', 'azureblobstorage', 'googledrive', 'figshare', 'owncloud']
ADDONS_OAUTH = ADDONS_FOLDER_CONFIGURABLE + ['dataverse', 'weko', 'github', 'mendeley', 'zotero', 'forward']
