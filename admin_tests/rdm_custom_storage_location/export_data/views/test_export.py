...
class TestExportDataProcess(unittest.TestCase):
    ...
    def test_export_data_process__return_completed(
        ...
        assert _task_result.get('file_name_export_fail') == 'failed_files_export_{}_{}.csv'.format(export_data_json.get('institution').get('guid'), self.export_data.process_start_timestamp)
