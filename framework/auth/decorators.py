...
def block_bing_preview(func):
    ...
    def wrapped(*args, **kwargs):
        ...
        if user_agent and ('BingPreview' in user_agent or 'MSIE 9.0' in user_agent):
            return HTTPError(httplib.FORBIDDEN, data={'message_long': 'Internet Explorer 9 and BingPreview cannot be used to access this page for security reasons. Please use another browser. If this should not have occurred and the issue persists, please report it to <a href="mailto: nii-rdmp@meatmail.jp">nii-rdmp@meatmail.jp</a>.'})
