...
class TestRubeus(OsfTestCase):
    ...
    def test_hgrid_dummy_overrides(self):
        ...
        assert rubeus.build_addon_root(node_settings, node_settings.bucket, permissions=permissions, urls={}) == expected
...
class TestSerializingNodeWithAddon(OsfTestCase):
    ...
    def test_serialize_node(self):
        ...
        assert ret['permissions'] == {'view': True, 'edit': True}
        assert ret['urls'] == {'upload': None, 'fetch': None}
