...
class TestCiteprocpyMLA(OsfTestCase):
    ...
    def test_render_citations_mla_one_author(self):
        ...
        assert citation == u'Tordoff, John. “{}.” {}, {}. Web.'.format(self.preprint.title, self.preprint.provider.name, self.formated_date)

        # test_suffix
        self.user.suffix = 'Junior'
        self.user.save()
        citation = render_citation(self.preprint, 'modern-language-association')
        assert citation == u'Tordoff, John, Junior. “{}.” {}, {}. Web.'.format(self.preprint.title, self.preprint.provider.name, self.formated_date)
    ...
    def test_citation_osf_provider(self):
        ...
        citation = render_citation(self.preprint, 'modern-language-association')
        assert citation == u'Tordoff, John. “{}” {}, {}. Web.'.format(self.preprint.title, 'GakuNin RDM', self.formated_date)

    def test_two_authors(self):
        self.preprint.add_contributor(self.second_contrib)
        self.preprint.save()
        citation = render_citation(self.preprint, 'modern-language-association')
        assert citation == u'Tordoff, John, and Carson Wentz. “{}.” {}, {}. Web.'.format(self.preprint.title, self.preprint.provider.name, self.formated_date)
    ...
    def test_three_authors(self):
        ...
        self.preprint.save()
        citation = render_citation(self.preprint, 'modern-language-association')
        assert citation == u'Tordoff, John, et al. “{}.” {}, {}. Web.'.format(self.preprint.title, self.preprint.provider.name, self.formated_date)

        # first name suffix
        self.user.suffix = 'Jr.'
        self.user.save()
        citation = render_citation(self.preprint, 'modern-language-association')
        assert citation == u'Tordoff, John, Jr., et al. “{}.” {}, {}. Web.'.format(self.preprint.title, self.preprint.provider.name, self.formated_date)
