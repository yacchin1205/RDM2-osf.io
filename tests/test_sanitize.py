...
class TestSanitize(unittest.TestCase):
    ...
    def test_sanitize_html_filters_css_properties(self):
        result = sanitize_html(
            '<p style="color: red; position: fixed; background-image: url(javascript:alert(1));">text</p>',
            tags={'p'},
            attributes={'p': ['style']},
            styles={'color'},
        )
    ...
    def test_sanitize_html_filters_unsafe_protocols(self):
        result = sanitize_html(
