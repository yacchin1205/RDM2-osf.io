...
RUN apt-get update \
    && apt-get install -y \
        curl \
    && gpg --keyserver hkp://pool.sks-keyservers.net:80 --recv-keys 7937DFD2AB06298B2293C3187D33FF9D0246406D 114F43EE0176B71C7BC219DD50A3051F888C628D \
...
COPY ./addons/weko/requirements.txt /code/addons/weko/
...
RUN pip install --no-cache-dir -c /code/requirements/constraints.txt -r /code/addons/box/requirements.txt \
    ...
    && pip install --no-cache-dir -c /code/requirements/constraints.txt -r /code/addons/weko/requirements.txt
...
COPY ./addons/weko/static/ /code/addons/weko/static/
