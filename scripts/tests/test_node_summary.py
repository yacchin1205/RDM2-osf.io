...
class TestNodeCount(OsfTestCase):
    ...
    # test_get_node_count
        ...
        assert nodes['total_excluding_spam'] == 3
        assert nodes['public'] == 1
        assert nodes['private'] == 3
        assert nodes['total_daily'] == 4
        assert nodes['total_daily_excluding_spam'] == 3
        assert nodes['public_daily'] == 1
        assert nodes['private_daily'] == 3
    ...
    # test_get_registered_nodes_count
        ...
        assert registered_nodes['public'] == 4
        ...
        assert registered_nodes['public_daily'] == 4
    ...
    # test_get_registered_projects_count
        ...
        assert registered_projects['total'] == 4
    ...
    # test_get_node_count daily zero
        ...
        assert nodes['total_daily'] == 0
        assert nodes['total_daily_excluding_spam'] == 0
        assert nodes['public_daily'] == 0
        assert nodes['private_daily'] == 0
    ...
    # test_get_registered_nodes_count daily zero
        ...
        assert registered_nodes['public_daily'] == 0
