...
var locked = _('${user} locked ${kind} ${path} in ${node}');
var unlocked = _('${user} unlocked ${kind} ${path} in ${node}');
...
var weko_file_added = _('${user} added draft file ${filename} to JAIRO Cloud index ${dataset} in ${node}');
var weko_file_removed = _('${user} removed draft file ${filename} from JAIRO Cloud index ${dataset} in ${node}');
var weko_index_linked = _('${user} linked JAIRO Cloud index ${dataset} to ${node}');
var weko_folder_created = _('${user} created draft folder ${filename} in JAIRO Cloud index ${dataset} in ${node}');
var weko_item_deposited = _('${user} deposit item ${path} in JAIRO Cloud index ${dataset} in ${node}');
var weko_node_authorized = _('${user} authorized the JAIRO Cloud addon for ${node}');
var weko_node_deauthorized = _('${user} deauthorized the JAIRO Cloud addon for ${node}');
var weko_node_deauthorized_no_user = _('JAIRO Cloud addon for ${node} deauthorized');
...
var s3compatsigv4_bucket_linked = _('${user} linked the S3 Compatible Storage (SigV4)  bucket ${bucket} to ${node}');
var s3compatsigv4_bucket_unlinked = _('${user} unselected the S3 Compatible Storage (SigV4)  bucket ${bucket} in ${node}');
var s3compatsigv4_file_added = _('${user} added file ${path} to S3 Compatible Storage (SigV4)  bucket ${bucket} in ${node}');
var s3compatsigv4_file_removed = _('${user} removed ${path} in S3 Compatible Storage (SigV4)  bucket ${bucket} in ${node}');
var s3compatsigv4_file_updated = _('${user} updated file ${path} in S3 Compatible Storage (SigV4)  bucket ${bucket} in ${node}');
var s3compatsigv4_folder_created = _('${user} created folder ${path} in S3 Compatible Storage (SigV4)  bucket ${bucket} in ${node}');
var s3compatsigv4_node_authorized = _('${user} authorized the S3 Compatible Storage (SigV4)  addon for ${node}');
var s3compatsigv4_node_deauthorized = _('${user} deauthorized the S3 Compatible Storage (SigV4)  addon for ${node}');
var s3compatsigv4_node_deauthorized_no_user = _('S3 Compatible Storage (SigV4)  addon for ${node} deauthorized');
