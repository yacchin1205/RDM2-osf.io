...
var logActions = require('js/_allLogTexts.json');
var anonymousLogActions = require('js/_anonymousLogTexts.json');
...
var nodeCategories = require('built/nodeCategories.json');
