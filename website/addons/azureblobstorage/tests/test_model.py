...
from website.addons.azureblobstorage.model import AzureBlobStorageNodeSettings
from website.addons.azureblobstorage.tests.factories import (
...
class TestNodeSettings(models.OAuthAddonNodeSettingsTestSuiteMixin, OsfTestCase):
    ...
    NodeSettingsClass = AzureBlobStorageNodeSettings
