<!-- Authorization -->
<div id='azureblobstorageAddonScope' class='addon-settings addon-generic scripted'
    ...
    <h4 class="addon-title">
        ...
        <small>
            <a href="#azureblobstorageInputCredentials" data-toggle="modal" class="pull-right text-primary">Connect Account</a>
        </small>
    </h4>
