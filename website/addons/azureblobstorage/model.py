...
from website.addons.azureblobstorage.utils import container_exists, get_bucket_names

from website.addons.azureblobstorage.provider import AzureBlobStorageProvider

class AzureBlobStorageUserSettings(AddonOAuthUserSettingsBase):

    oauth_provider = AzureBlobStorageProvider
    serializer = AzureBlobStorageSerializer


class AzureBlobStorageNodeSettings(StorageAddonBase, AddonOAuthNodeSettingsBase):
    ...
    def delete(self, save=True):
        ...
        super(AzureBlobStorageNodeSettings, self).delete(save=save)
