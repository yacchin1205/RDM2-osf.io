...
function ViewModel(url) {
    ...
    /** Reset all fields from NII Swift credentials input modal */
    ...
    self.connectAccount = function() {
        ...
        return osfHelpers.postJSON(
            ...
            Raven.captureMessage('Could not authenticate with NII Swift', {
                extra: {
    ...
    self.askDisconnect = function(account) {
        var self = this;
        bootbox.confirm({
            title: 'Disconnect NII Swift Account?',
            message: '<p class="overflow">' +
                'Are you sure you want to disconnect the NII Swift account <strong>' +
                osfHelpers.htmlEscape(account.name) + '</strong>? This will revoke access to NII Swift for all projects associated with this account.' +
                '</p>',
