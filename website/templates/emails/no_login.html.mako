...
<%def name="content()">
    <div style="margin: 40px;">
        ...
        If you have specific questions, or would like to set up a free training session for you and your colleagues, please do not hesitate to <a href="mailto:nii-rdmp@meatmail.jp">get in touch with us!</a>
        <br><br>
        Best,
        <br>
        COS Support Team
